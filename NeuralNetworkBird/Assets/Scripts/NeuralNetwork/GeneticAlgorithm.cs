...
public class GeneticAlgorithm : MonoBehaviour
{
    ...
    GenerationSummaryData lastSummaryData, newSummaryData;
    private void OnEnable()
    {
        GameManager.Instance.onGenerationSummaryEnd.AddListener(StartNewGeneration);
    }
    private void OnDisable()
    {
        GameManager.Instance.onGenerationSummaryEnd.RemoveListener(StartNewGeneration);
    ...
    //Click continue button in summary display
    public void StartNewGeneration()
    {
        CreateNewGeneration();
        simulationsHistoryUIDisplay.NewGeneration(currentGeneration);
    }
    float CalculateAvgFitness()
    {
    ...
    {
        string generationFileName = "/GenerationSummary.csv";
        File.AppendAllText(savePath + generationFileName, $"\n{generationIndex};{((int)(generationSummaryData.avgFitness)).ToString()}");
    }
}
